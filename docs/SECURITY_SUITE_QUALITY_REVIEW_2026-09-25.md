...
The corrected post-change execution, run 36210983563, completed successfully at `a369805cc38c90582ef31252562f829ad6571ac5`: 243/243 executed, 230 passed, 13 observations and no infrastructure failure. Its uploaded `vocle-security-discovery` artifact has digest `sha256:f6f0747403d3a009229f74422525ae92fcc5b6ebe7497af39ab88989da003aac`. The observation IDs match the pre-change set, so the hardening preserved legitimate observations while eliminating the two order-dependent false observations.
