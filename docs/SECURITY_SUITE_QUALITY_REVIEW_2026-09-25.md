...
The pre-change evidence remains run 36168079327: 243 executed, 230 passed and 13 observations. Strengthening assertions does not reclassify that historical artifact. A fresh workflow run is required to state the post-change pass/observation totals.
