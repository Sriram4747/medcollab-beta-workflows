...
- Discovery cases passed: 312
- Discovery observations: 40
...
| POST | `/api/channels/dm` | EXERCISED — 9 pass, 2 observation (Direct Messages: 9; Message Requests: 2) | `src/features/channels/channel.routes.js` |
| POST | `/api/channels/dm/group` | NOT YET EXERCISED | `src/features/channels/channel.routes.js` |
...
| POST | `/api/handoffs/:id/notes` | NOT YET EXERCISED | `src/features/handoffs/handoff.routes.js` |
| POST | `/api/handoffs/:id/reassign` | NOT YET EXERCISED | `src/features/handoffs/handoff.routes.js` |
...
| POST | `/api/message-requests` | EXERCISED — 13 pass, 4 observation (Message Requests: 17) | `src/features/message-requests/messageRequest.routes.js` |
...
| GET | `/api/users/me/needl` | NOT YET EXERCISED | `src/features/users/user.routes.js` |
